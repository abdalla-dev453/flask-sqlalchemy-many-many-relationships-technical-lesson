...
# Association table -> for employee and meeting
...
class Employee(db.Model):
    ...
    # Association to get proxies for projects through assignments
...
class Project(db.Model):
    ...
    # Association to get proxies for employees through assignments
...
class Assignment(db.Model):
    ...
    # Foreign key to store employee_id
    employee_id = db.Column(db.Integer, db.ForeignKey('employees.id'))
    # Foreign key to store project_id
